...
public class BaseFrame extends JFrame{
	...
	static {
		try {
			connection = DriverManager.getConnection("jdbc:mysql://localhost?serverTimezone=UTC&allowLoadLocalInfile=true","user","1234");
	...
	public static void errorMessage(String msg) {
		JOptionPane.showInternalMessageDialog(null, msg,"메세지",JOptionPane.ERROR_MESSAGE);
	}
	
	public static void informationMessage(String msg) {
		JOptionPane.showInternalMessageDialog(null, msg,"메세지",JOptionPane.INFORMATION_MESSAGE);
	}
